...
type PatchJobSpec struct {
	...
	// foo is an example field of PatchJob. Edit patchjob_types.go to remove/update
	// +optional
...
type PatchJobStatus struct {
	...
	// conditions represent the current state of the PatchJob resource.
...
type PatchJob struct {
	...
	// spec defines the desired state of PatchJob
	// +required
	Spec PatchJobSpec `json:"spec"`

	// status defines the observed state of PatchJob
	// +optional
	Status PatchJobStatus `json:"status,omitzero"`
}
